        ...
        <section class="top">
            <ul class="socials">
                <li class="icon bootstrap">
                    <a class="icons" href="https://getbootstrap.kr/"> 
                ...
                <li class="icon github">
                    <a class="icons" href="https://github.com/jec93/semi_community_project.git">
                ...
                <li class="icon oracle">
                    <a class="icons" href="https://www.oracle.com/kr/database/"> 
...
<script src="/resources/js/aside.js" defer></script>